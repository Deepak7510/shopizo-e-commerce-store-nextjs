    ...
    return (
        <Link key={productItem._id} href={''}>
            < Card className='p-1 rounded-md h-full shadow-none gap-0'>
                <div className="h-48 md:h-64 relative w-full rounded-t-sm overflow-hidden">
                    <Image
                ...
                <div className='p-1'>
                    ...
                    <h2 className='font-medium text-xs md:text-sm' >{stringShorter(productItem.title, 15)}</h2>
